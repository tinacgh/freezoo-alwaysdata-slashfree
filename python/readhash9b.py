...
.pronlink { font-size: 12px; font-family: Arial Narrow, Arial, sans-serif; color: #009; padding: 5px; background-color: #9cf; width: 100%; position: fixed; top: 0px; left: 0px; }
</style>
...
#9b
<div id="formid">
<form action="readhash9b.py" method="post">
